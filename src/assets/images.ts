const generic_images = {
    ...
    add: {
        add_icon: require('./img/generic/add/add_icon.png')
    }
}
...
const app_patient_images = {
    ...
    profile: {
        ...
        icon_calendar: require('./img/app_patient/profile/calendar_icon.png'),
        icon_gender: require('./img/app_patient/profile/gender_icon.png')
    },
    health: {
        call: {
        ...
        medicines: {
            ...
            medicine_liquid_icon: require('./img/app_patient/health/medicines/medicine_liquid_icon.png'),
            medicine_capsule_icon: require('./img/app_patient/health/medicines/medicine_capsule_icon.png'),
            medicine_pill_icon: require('./img/app_patient/health/medicines/medicine_pill_icon.png'),
            ...
            current_medications_illustration: require('./img/app_patient/health/medicines/current_medications_illustration.png'),
            no_current_medications: require('./img/app_patient/health/medicines/no_current_medications.png'),
            medicine_pill_type: require('./img/app_patient/health/medicines/medicine_pill_type.png'),
            medicine_capsule_type: require('./img/app_patient/health/medicines/medicine_capsule_type.png'),
            medicine_liquid_type: require('./img/app_patient/health/medicines/medicine_liquid_type.png'),
            liquid_medication: require('./img/app_patient/health/medicines/liquid_medication.png'),
            capsule_medication: require('./img/app_patient/health/medicines/capsule_medication.png'),
            pill_medication: require('./img/app_patient/health/medicines/pill_medication.png'),
            remove_capsule: require('./img/app_patient/health/medicines/remove_capsule.png'),
            remove_pill: require('./img/app_patient/health/medicines/remove_pill.png'),
            remove_liquid: require('./img/app_patient/health/medicines/remove_liquid.png'),
        },
        quiz: {
            quiz_card_illustration: require('./img/app_patient/health/quiz/quiz_card_illustration.png'),
            quiz_background: require('./img/app_patient/health/quiz/quiz_background.png'),
            answer_questionnaire_illustration: require('./img/app_patient/health/quiz/answer_questionnaire_illustration.png'),
            quiz_card_illustration_checked: require('./img/app_patient/health/quiz/quiz_card_illustration_checked.png'),
            answer_questionnaire_template: require('./img/app_patient/health/quiz/answer_questionnaire_template.png'),
            current_questionnaire_illustration: require('./img/app_patient/health/quiz/current_questionnaire_illustration.png'),
            performance_icon_excelente: require('./img/app_patient/health/quiz/performance_icon_excelente.png'),
            performance_icon_otimo: require('./img/app_patient/health/quiz/performance_icon_otimo.png'),
    ...
    bluetooth: {
        ...
        no_devices: require('./img/app_patient/bluetooth/no_devices.png'),
        device_icon: require('./img/app_patient/bluetooth/device_icon.png'),
        search_devices: require('./img/app_patient/bluetooth/search_devices.png'),
        current_device_icon: require('./img/app_patient/bluetooth/current_device_icon.png')
    }
}
...
const app_doctor_images = {
    ...
    profile: {
        ...
        icon_calendar: require('./img/app_doctor/profile/calendar_icon.png'),
        icon_gender: require('./img/app_doctor/profile/gender_icon.png')
    },
    analysis: {
        ...
        no_patients_to_analyze: require('./img/app_doctor/analysis/no_patients_to_analyze.png'),
        latest_medications_icon: require('./img/app_doctor/analysis/latest_medications_icon.png'),
        latest_questionnaires_icon: require('./img/app_doctor/analysis/latest_questionnaires_icon.png'),
        currentstate_critico_icon: require('./img/app_doctor/analysis/currentstate_critico_icon.png'),
        currentstate_precisadeatencao_icon: require('./img/app_doctor/analysis/currentstate_precisadeatencao_icon.png'),
        currentstate_nadamal_icon: require('./img/app_doctor/analysis/currentstate_nadamal_icon.png'),
        currentstate_bom_icon: require('./img/app_doctor/analysis/currentstate_bom_icon.png'),
        currentstate_otimo_icon: require('./img/app_doctor/analysis/currentstate_otimo_icon.png'),
        currentstate_excelente_icon: require('./img/app_doctor/analysis/currentstate_excelente_icon.png'),
        current_patient_medications: require('./img/app_doctor/analysis/current_patient_medications.png'),
        current_patient_questonnaires: require('./img/app_doctor/analysis/current_patient_questionnaires.png'),
        capsule_medication: require('./img/app_doctor/analysis/capsule_medication.png'),
        liquid_medication: require('./img/app_doctor/analysis/liquid_medication.png'),
        pill_medication: require('./img/app_doctor/analysis/pill_medication.png'),
        no_current_medications: require('./img/app_doctor/analysis/no_current_medications.png'),
        no_current_questionnaires: require('./img/app_doctor/analysis/no_current_questionnaires.png'),
    },
    notepad: {
        ...
        no_notepads: require('./img/app_doctor/notepad/no_notepads.png'),
        note_part: require('./img/app_doctor/notepad/note_part.png'),
        drag_up: require('./img/app_doctor/notepad/drag_up.png')
    }
}
...
const animations = {
    ...
    patient_illustration: require('./animations/patient_illustration.json'),
    pensative_icon: require('./animations/pensative_icon.json'),
