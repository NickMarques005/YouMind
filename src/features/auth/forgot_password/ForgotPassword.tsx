...
const ForgotPassword = ({ isVisible, onClose }: ForgotPasswordProps) => {
    ...
    const arrow_back_patient = images.generic_images.back.arrow_back_patient;
    const arrow_back_doctor = images.generic_images.back.arrow_back_doctor;
                    ...
                    <TouchableOpacity onPress={onClose} style={styleforgot.buttonVoltar}>
                        {
                            userType === "doctor" ?
                                <Image
                                    source={arrow_back_doctor}
                                    style={styleforgot.imgIconBack} />
                                :
                                <Image
                                    source={arrow_back_patient}
                                    style={styleforgot.imgIconBack} />
                        }
                    </TouchableOpacity>
