...
interface TreatmentHeader {
    ...
    userData?: UserData;
    handleSearch?: () => void;
    handleTreatmentMenu: () => void;
    treatmentMenu: boolean;
    closeMenu: () => void;
        ...
        <>
            <LinearGradient colors={[`${userType == "patient" ? "#753567" : "#355f75"}`, `${userType == "patient" ? '#9b3aa6' : "#3a94a6"}`,]}
                ...
                <View style={styles.headerIcons_View}>
                    <TouchableOpacity style={[styles.menuIcon_Button, { width: iconButtonWidth }]} onPress={() => treatmentMenu ? closeMenu() : handleTreatmentMenu()}>
                    ...
                    {
                        userType === 'doctor' ?
                            <TouchableOpacity style={styles.menuIcon_Button} onPress={() => {
                                treatmentMenu && closeMenu();
