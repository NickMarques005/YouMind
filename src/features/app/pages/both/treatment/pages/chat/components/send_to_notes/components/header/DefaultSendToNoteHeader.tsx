...
interface DefaultSendToNoteHeaderProps {
    userType: UserType;
    handleBackToChat: () => void;
}

const DefaultSendToNoteHeader: React.FC<DefaultSendToNoteHeaderProps> = ({
    userType,
    handleBackToChat
}) => {
    ...
    return (
        <View style={[styles.header_container, { backgroundColor: userType === 'doctor' ? '#3a94a6' : '#9b3aa6' }]}>
            ...
            <View style={styles.titleContainer}>
                <Text style={styles.title}>Escolha uma anotação</Text>
            </View>
        </View>
    );
};
...
export default DefaultSendToNoteHeader;