...
const MedicationInfo: React.FC<MedicationInfoProps> = ({ form, handleInputChange, suggestions, setSuggestions, loading, dosageUnits, handleSuggestionSelection }) => {
    ...
    return (
        <View style={styles.medicationCharacteristics}>
            <View style={{ backgroundColor: '#a468b3', position: 'absolute', top: '-5%', left: '3%', height: sizeIcon, width: sizeIcon, borderRadius: sizeIcon, alignItems: 'center', justifyContent: 'center' }}>
                <MaterialIcons name="medication" size={sizeIcon * 0.5} color="white" />
            </View>
